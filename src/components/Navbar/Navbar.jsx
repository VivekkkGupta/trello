...
function Navbar() {
    ...
    // Ensure username exists before rendering
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div className="relative" ref={dropdownRef}>
                        <div
                            ...
                            onClick={() => setShowProfileDropDown((prevState) => !prevState)}
                        >
                            <i className="ri-account-circle-fill text-3xl"></i>
                        </div>
                        {showProfileDropDown && (
                            <div className="absolute right-0 mt-2 bg-white border border-gray-200 rounded-lg shadow-lg py-2 w-40 z-10 transition-opacity duration-300">
                                <div
