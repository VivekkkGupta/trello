    ...
    return (
        <>
            ...
            <div className='w-[50%] h-12 flex flex-col md:flex-row justify-around items-center gap-5'>
                <button className='w-full bg-slate-400 py-2 px-3 rounded-md font-[500] hover:bg-slate-500 duration-200 transition-all' onClick={handleSignupButton}>Register</button>
